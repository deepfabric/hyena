...
func parseOptions() []server.Option {
	...
	opts = append(opts, server.WithRaftOption(raftstore.WithProphetOption(prophet.WithMaxScheduleInterval(time.Second*time.Duration(*prophetScheduleMaxIntervalSec)))))
