...
func (ps *peerStorage) doGenSnapJob() error {
	...
	msg.Header.CommittedOffset, msg.Header.CommittedIndex = ps.committedOffset()
...
func (pr *PeerReplicate) doAskSplit(db meta.VectorDB, committedOffset, committedIndex int64) error {
